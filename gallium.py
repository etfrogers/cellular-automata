...
if strcmp(time_domain, 'gaussTY')
    tim=1;   Ontime=2*Tao; power=0.9394*fluence/tao;  end
if strcmp(time_domain, 'gaussTN')
    tim=0;  Ontime=Tao; power=1*fluence/tao;  end

if strcmp(raise_style, 'uniformY')
    rai=0;   end
if strcmp(raise_style, 'uniformN')
    rai=1;   end   #tim=0(1) denotes rectangular pulse(gauss pulse); gao=1,0 is gauss shape or#rectangular shap;#rai=0(1) denotes the rasi12 is constant or exponentially decrease;
